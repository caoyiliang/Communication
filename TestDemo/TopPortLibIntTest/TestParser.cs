...
namespace TopPortLibIntTest
{
    ...
    public class TestParser
    {
        ...
        private readonly byte[] _data = [0x7B, 0x7B, 0x11, 0xBB, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1D, 0x05, 0x80, 0x41, 0x00, 0x00, 0x80, 0xBF, 0x00, 0x00, 0x80, 0xBF, 0x00, 0x00, 0x80, 0xBF, 0x00, 0x00, 0x80, 0xBF, 0x00, 0x07, 0xE2, 0x00, 0x0A, 0x00, 0x7B, 0x7B, 0x78, 0x45, 0x56, 0x12, 0x45];
        ...
        {
            ITopPort port = new TopPort(physicalPort, new HeadLengthParser([0x7B], new GetDataLengthEventHandler(async data =>
            {
            ...
            while (!cts.IsCancellationRequested)
            {
                ...
                Assert.HasCount(_data.Length, data);
